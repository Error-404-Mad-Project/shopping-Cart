        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(!(dataSnapshot.child("Users").child(name).exists()))
                {
                        ...
                        RootRef.child("Users").child(name).updateChildren(userdataMap)
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        {
                                            Toast.makeText(Register.this, "Your account hasbeen created..",Toast.LENGTH_SHORT).show();
                                            loadingBar.dismiss();
                                            ...
                                            Toast.makeText(Register.this, "Network Error,Plase try again..",Toast.LENGTH_SHORT).show();
                                            loadingBar.dismiss();
                                        }
                    ...
                    Toast.makeText(Register.this,"This" + name + "already use.",Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                    Toast.makeText(Register.this, "Please try again using another name..",Toast.LENGTH_SHORT).show();
